...
pub fn smooth_lerp(start_n: f32, end_n: f32, current_t: f32, start_t: f32, end_t: f32) -> f32 {
...
#[inline]
pub fn lerp(start_n: f32, end_n: f32, current_t: f32, start_t: f32, end_t: f32) -> f32 {
    let progress = progress(start_t, end_t, current_t);
